...
public class ContactAdapter extends BaseExpandableListAdapter {
	...
	public void initFriendList(List<ContactGroup> grouplist,
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null
			...
			holder2.item_user_chat = ((ImageView) convertView
		...
		if (mi.getCon_uid() == null) {
			type = "[非系统用户]";
			holder2.item_user_chat.setVisibility(View.GONE);
			if (selectMember) {
			...
			if (mi.getType() == 0
				...
				if (mi.getState() == EB_USER_LINE_STATE.EB_LINE_STATE_OFFLINE
						.getValue()) {
					holder2.userImg
							.setImageBitmap(AbImageUtil.grey(BitmapFactory
