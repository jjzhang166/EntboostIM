...
public class WelcomeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		EntboostLC.initAPPKey(MyApplication.appid,
				MyApplication.appkey, new InitAppKeyListener() {
					...
					public void onInitAppKeySuccess() {
						// 检查应用程序版本
						String clientVer = AppUtils
								.getVersion(WelcomeActivity.this);
						VersionUtils
								.checkApkVer(
										clientVer,
										WelcomeActivity.this,
										new CheckClientVerListener(){

											@Override
											public void onFailure(String errMsg) {
												// 判断是否默认登录，如果是默认登录就直接登录到主界面，如果不是就打开登录界面
												boolean defaulLogon = EntboostCache
														.getDefaultLogon();
												if (!defaulLogon) {
													finish();
													...
													EntboostLC
															.logon(new LogonAccountListener() {
