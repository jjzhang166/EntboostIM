...
public class FunctionMainActivity extends EbActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String url = funcInfo.getFunc_url();
		...
		mWebView.setWebViewClient(new WebViewClient() {
			...
			public boolean shouldOverrideUrlLoading(final WebView view,
				...
				EntboostUM.fnavArgs(url, new FnavArgsListener() {
					...
					@Override
					public void send_group_start() {
						showProgressDialog("开始群组会话，请等待");
					}

					@Override
					public void send_group_failure(Long depCode, String err) {
						removeProgressDialog();
						UIUtils.showToast(FunctionMainActivity.this, err);
					}
					...
					@Override
					public void send_account_start() {
						showProgressDialog("开始个人会话，请等待");
					}
					...
					@Override
					public void send_account_failure(String account, String err) {
						removeProgressDialog();
						UIUtils.showToast(FunctionMainActivity.this, err);
					}
