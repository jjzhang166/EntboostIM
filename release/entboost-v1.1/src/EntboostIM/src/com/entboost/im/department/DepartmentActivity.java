...
import com.entboost.enterprise.EbEnterpriseCache;
import com.entboost.im.R;
import com.entboost.im.base.EbActivity;
import com.lidroid.xutils.ViewUtils;
import com.lidroid.xutils.view.annotation.ViewInject;

public class DepartmentActivity extends EbActivity {
	@ViewInject(R.id.departmentlist)
	private ExpandableListView listView;
	private DepartmentAdapter friendAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		friendAdapter = new DepartmentAdapter(this);
		friendAdapter.initFriendList(
				EbEnterpriseCache.getDepartmentMemberInfos(),
				EbEnterpriseCache.getDepartments());
